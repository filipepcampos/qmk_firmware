...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 _______,_______,_______,TL_LOWR, KC_ENT,        KC_SPC,  TL_UPPR, _______, _______, _______
),
...
[_RAISE] = LAYOUT(
  ...
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, KC_CAPS,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, KC_BSPC,
